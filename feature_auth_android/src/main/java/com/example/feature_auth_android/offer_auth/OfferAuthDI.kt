...
import com.example.feature_auth.offer_auth.side_effects.AcceptAuthOfferSideEffect
import com.example.feature_auth.offer_auth.side_effects.FetchAuthScreenDataSideEffect
import com.example.feature_auth.offer_auth.side_effects.RejectAuthOfferSideEffect
...
val offerAuthAndroidModuleDI = module {
    single<StateObservable<OfferAuthStore.State>> (named(OFFER_AUTH_STATE_OBSERVABLE)) { LiveDataStateObservable(
        OfferAuthStore.State()) }
